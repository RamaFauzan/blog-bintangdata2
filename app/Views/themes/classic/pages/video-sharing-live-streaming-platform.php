  ...
  <style>
    ...
    * {
    ...
    .hero {
      ...
      background:
        radial-gradient(circle at 83% 17%,
          rgba(35, 191, 255, 0.08),
          transparent 25%),
        radial-gradient(circle at 8% 98%,
          rgba(255, 196, 0, 0.18),
          transparent 22%),
  ...
  <main>
    <section class="hero" id="home">
      ...
      <div class="container hero-grid">
        ...
        <div class="mockup-area" aria-label="Video platform interface preview">
          <div class="laptop">
                ...
                <aside class="sidebar-panel">
                  ...
                  <div class="stream-list">
                    <div class="stream-card">
                      ...
                      <div>
                        <strong>Across The Metaverse</strong><span>1.2M views</span>
                      </div>
                    </div>
                    <div class="stream-card">
                      <span class="thumb"></span>
                      <div>
                        <strong>Nomadic Paths</strong><span>Live discussion</span>
                      </div>
                    </div>
                    <div class="stream-card">
                      <span class="thumb"></span>
      ...
      <div class="container split-grid">
        <div class="stat-card">
          <div class="stat-grid">
            ...
            <div class="stat-item">
              <strong>Live</strong><span>Real-time stream and chat system</span>
            </div>
            <div class="stat-item">
