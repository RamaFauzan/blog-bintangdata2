                        ...
                        foreach ($featuredPosts as $item):
                            if ($i < 2):?>
                                <div class="col-12 <?= $i == 0 ? ' col-first' : ''; ?>">
                                    <div class="item">
                                        <a href="<?= generatePostURL($item); ?>" class="img-link"<?php postURLNewTab($item); ?> aria-label="post">
                                            <img src="<?= IMG_BASE64_1x1; ?>" data-src="<?= getPostImage($item, 'slider'); ?>" alt="<?= esc($item->title); ?>" class="img-fluid lazyload" width="310" height="253"/>
                                ...
                                foreach ($featuredPosts as $item):
                                    if ($i > 1 && $i <= 9): ?>
                                        <div class="item <?= $i == 2 ? ' item-first' : ''; ?>">
                                            ...
                                            <div style="margin-bottom: 0;" class="tbl-container post-item-small<?= checkPostImg($item, 'class'); ?>">
                                                    <div class="tbl-cell left">
                                                            <div class="image">
                                                                <a href="<?= generatePostURL($item); ?>">
                                                                    <img src="<?= IMG_BASE64_1x1; ?>" data-src="<?= getPostImage($item, 'small'); ?>" alt="<?= esc($item->title); ?>" class="img-fluid lazyload" width="130" height="91"/>
                                                                </a>
                                                            </div>
                                                    </div>
